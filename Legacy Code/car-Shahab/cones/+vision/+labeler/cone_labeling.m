...
% algorithm, to be used in labeling apps (Image Labeler and Ground Truth
% Labeler). To access help for this class, enter the following at the
...
%
%
% To use this algorithm from within the Image Labeler or Ground Truth
...
classdef cone_labeling < vision.labeler.AutomationAlgorithm
    ...
    methods
        ...
        function isReady = checkSetup(algObj)
            ...
            % Place your code here
            %--------------------------------------------------------------
            labelsToAutomate = algObj.SelectedLabelDefinitions;
    ...
    methods
        ...
        function initialize(algObj, I)
            ...
            % Place your code here
            %--------------------------------------------------------------
            algObj.detector = vision.CascadeObjectDetector('cone_detector.xml');
        ...
        function autoLabels = run(algObj, I)
            ...
            bbox = step(algObj.detector, I);
            autoLabels = struct;
                autoLabels.Type = algObj.SelectedLabelDefinitions.Type;
