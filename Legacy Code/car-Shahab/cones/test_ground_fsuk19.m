...
im = imread(fn{1});
[imL_distorted, imR_distorted] = split_stereo_image(im); % WARNING: Flipped!
...
% Right image
Or = [153; 333] + 1; % Origin
Xr = [476; 312] + 1; % Right axis
Yr = [185; 303] + 1; % Forward axis

% Left image
Ol = [157; 341] + 1; % Origin
Xl = [487; 360] + 1; % Right axis
Yl = [158; 310] + 1; % Forward axis
