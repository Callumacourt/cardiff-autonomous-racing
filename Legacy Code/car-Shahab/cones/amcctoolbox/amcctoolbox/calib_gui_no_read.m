...
cell_list{3,2} = {'Save','saving_calib_auto;'};
...
cell_list{4,2} = {'Undistort image(s)','undistort_image_no_read;'};
cell_list{4,3} = {'Export calib data','export_calib_data;'};
cell_list{4,4} = {'Show calib results','show_calib_results;'};
cell_list{5,1} = {'Export to OpenCV Intrinsics','export_opencv_intrinsics_mono;'};
cell_list{5,2} = {'Export calibration to ROS YAML','export_yaml_intrinsics;'};

show_window(cell_list,fig_number,title_figure,130,18,0,'clean',8);
