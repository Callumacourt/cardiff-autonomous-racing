...
for kk =  ind_active,
   ...
   if ~exist(['x_' num2str(kk)]),
      ...
      fprintf('WARNING: Need to extract grid corners on image %d\n',kk);
	 ...
	 fprintf('WARNING: Need to extract grid corners on image %d - This image is now set inactive.\n'    ,kk);
%'This is OK if you are loading from a paused Calib_Data file, the checkerboard was not found in that image.\n'
	 active_images(kk) = 0;
