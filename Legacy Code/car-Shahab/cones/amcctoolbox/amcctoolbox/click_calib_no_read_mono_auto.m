...
for kk = ima_proc,
    ...
    if exist(ima_name),
        ...
        fprintf(1,['\n**************** Processing image %d of ' calib_name ' ****************\n'],kk);
        ...
        % Histgram equalization can enhance the contrast for underwater
        % dataset
...
string_save = 'save calib_data fisheye active_images ind_active wintx winty n_ima type_numbering N_slots first_num image_numbers format_image calib_name Hcal Wcal nx ny map dX_default dY_default dX dY';
