...
% fig_number = 1;
% 
% title_figure = 'RADOCC Camera Calibration Toolbox - Select mode of operation:';
% 
% cell_list{1,1} = {'Memory efficient','calib_gui_no_read;'};
% cell_list{2,1} = {'Standard (all the images are stored in memory)','calib_gui_normal;'};
...
% Force memory efficient mode. The upgrades to the AMCCToolbox are not
% compatible with the old standard mode
calib_gui_no_read;