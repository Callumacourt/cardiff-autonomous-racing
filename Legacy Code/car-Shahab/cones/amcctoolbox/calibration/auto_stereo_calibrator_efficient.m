% AUTO_STEREO_CALIBRATOR_EFFICIENT(camera_vec, input_dir, output_dir, format_image, dX, dY, proj_tol, rotcam, cam0_names, cam1_names, fisheye, k3_enable)
% Performs an automatic stereo calibration by performing two monocular
% calibrations, then performs a stereo calibration on the data
...
function auto_stereo_calibrator_efficient(camera_vec, input_dir, output_dir, format_image, dX, dY, nx_crnrs, ny_crnrs, proj_tol, rotcam, cam0_names, cam1_names, fisheye, k3_enable)
...
% calibrate the mono camera
auto_mono_calibrator_efficient;
