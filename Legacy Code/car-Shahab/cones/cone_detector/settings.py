...
class Settings(wx.Panel):
    def __init__(self, parent, id=wx.ID_ANY,
        ...
        pg.Append(wxpg.FileProperty("Detector model", "CD_FILENAME", value=config.CD_FILENAME))
        pg.Append(wxpg.FloatProperty("Pyramid levels", name="CD_PYRAMID_LEVELS", value=config.CD_PYRAMID_LEVELS))
        ...
        pg.Append(wxpg.FloatProperty("Absolute threshold", "CD_ABS_THRESHOLD", value=config.CD_ABS_THRESHOLD))
        ...
        pg.Append(wxpg.EnumProperty("Video source", name="VIDEO_SOURCE", labels=['Camera', 'Image folder'], values=[0, 1], value=config.VIDEO_SOURCE))
        ...
        self.append_bool_property(pg, "Show detection map", "SHOW_ORIGINAL_DETECTIONS", True)
