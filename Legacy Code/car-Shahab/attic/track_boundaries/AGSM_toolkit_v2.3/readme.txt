...
The Matlab version of the GVF algorithm can be downloaded at: http://www.iacl.ece.jhu.edu/static/gvf/
The s-t graph cuts algorithm can be downloaded at: http://vision.csd.uwo.ca/code/ 
The active contours algorithm that we used for comparison can be downloaded at: http://www.engr.uconn.edu/~cmli/DRLSE/
