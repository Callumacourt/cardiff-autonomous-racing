...
from OpenGL.GL import (shaders, glMatrixMode, glLoadIdentity, glViewport, glClear, glClearColor,
                       ...
                       glPointSize, glAlphaFunc, glHint, glBegin, glEnd, glVertex2f,
...
from image import *
from tools import select_texture, draw_quad, draw_quad_solid
from log import log
import FTGL
...
class ImageViewer(glcanvas.GLCanvas):
    ...
    def after_init(self):
        ...
        self.font = FTGL.TextureFont('resources/VL-Gothic-Regular.ttf')
    ...
    def OnDraw(self):
        ...
        if wx.GetApp().autopilot_thread.paused:
            self.text(10, 20, "PAUSED")
        else:
            self.text(10, 20, "FPS: %.2f" % wx.GetApp().autopilot_thread.FPS)
