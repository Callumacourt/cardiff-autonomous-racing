"""Application of CNNs using CUDA and cuDNN."""
...
class CNN:
    def __init__(self, layers, context=None, cudnn_context=None, kernels=None):
        self.layers = layers
    ...
    # Allocate output buffer if necessary
        ...
        for i, layer in enumerate(self.layers):
            ...
            if layer.relu:
                ...
                n = self.Y[i].size
                self.kernels.relu(self.Y[i], np.int32(n),
