...
parser = argparse.ArgumentParser(description='Visualise NN genome.')
...
draw_net(config, genome, view=False, filename=args.genome, node_names=None, show_disabled=False, prune_unused=False,
